...
<body>
    <main>
        <section class="px-24 pt-24">
            <form class="py-8" action="proses-input.php" method="post">
                <div class="space-y-12">
                    <div>
                        <h2 class="text-base font-semibold leading-7 text-gray-900">Input Mahasiswa</h2>
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="text" name="npm" id="npm" autocomplete="npm" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <input id="nama" name="nama" type="text" autocomplete="nama" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                                ...
                                <fieldset>
                                    ...
                                    <div class="mt-6 space-y-6">
                                        <div class="flex items-center gap-x-3">
                                            <input value="L" id="laki-laki" name="jenis_kelamin" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                            <label for="laki-laki" class="block text-sm font-medium leading-6 text-gray-900">Laki-laki</label>
                                        </div>
                                        <div class="flex items-center gap-x-3">
                                            <input value="P" id="perempuan" name="jenis_kelamin" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
